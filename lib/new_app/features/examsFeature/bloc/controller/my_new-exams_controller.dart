...
class MyNewExamsController extends GetxController{
  List<Exam> exams = [];
  bool isLoading = false;
  MyNewExamsRepository _myNewExamsRepository = MyNewExamsRepository();
  Future<void> fetchMyNewExams() async {
      isLoading = true;
      update();
    var response = await _myNewExamsRepository.fetchMyNewExams();
